package com.mridini.login.config;
...
import com.mridini.login.constant.Api;
...
public class SecurityConfig {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
				...
				.authorizeHttpRequests(authorize -> authorize.requestMatchers(Api.AUTH + "/**","/error",Api.USER+"/**").permitAll()
